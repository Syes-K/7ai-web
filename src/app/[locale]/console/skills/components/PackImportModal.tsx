...
import { App, Button, Modal, Progress, Table, Upload } from "antd";
...
const API_IMPORT = "/api/console/skill-configs/import";
...
export default function PackImportModal({ open, onClose, onImported }: Props) {
  ...
  const uploadZip = useCallback(
    ...
    [message, processResponse, tShell],
  );
